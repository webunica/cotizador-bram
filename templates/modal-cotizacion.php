            ...
            <div class="cotizador-step-content" id="step-datos">
                ...
                <form id="modal-form-cotizacion">
                    <div class="form-grid">
                        ...
                        <div class="form-group form-group-full" style="background: linear-gradient(135deg, #d4edda 0%, #c3e6cb 100%); border: 3px solid #28a745; border-radius: 12px; padding: 25px; margin: 25px 0;">
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                                <input type="checkbox" id="aplicar_descuento" name="aplicar_descuento" value="si" style="width: 28px; height: 28px; cursor: pointer; accent-color: #28a745;" data-descuento="4">
                                <label for="aplicar_descuento" style="cursor: pointer; margin: 0; flex: 1; font-size: 18px; font-weight: bold; color: #155724;">💰 Deseo 4% de descuento pagando con transferencia</label>
                            </div>
                            <p style="margin: 0 0 0 43px; font-size: 14px; color: #155724;">Al seleccionar esta opción, recibirás los datos bancarios para realizar la transferencia con descuento.</p>
                            <div id="info-descuento" style="display: none; margin-top: 20px; padding-top: 20px; border-top: 2px dashed #28a745;">
                                <div style="background: #fff; padding: 20px; border-radius: 8px;">
                                    <h4 style="margin: 0 0 15px 0; color: #155724;">✓ Ahorro con Transferencia</h4>
                                    <div id="calculo-descuento">
                                        <div style="display: flex; justify-content: space-between; padding: 10px 0; border-bottom: 1px solid #e0e0e0;"><span>Total normal:</span><span id="total-normal" style="font-weight: bold;">$0</span></div>
                                        <div style="display: flex; justify-content: space-between; padding: 10px 0; border-bottom: 1px solid #e0e0e0;"><span style="color: #28a745;">Descuento (4%):</span><span id="monto-descuento" style="font-weight: bold; color: #28a745;">-$0</span></div>
                                        <div style="display: flex; justify-content: space-between; padding: 15px; background: #28a745; color: white; margin: 10px -20px -20px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;"><span style="font-size: 18px; font-weight: bold;">Total a pagar:</span><span id="total-con-descuento" style="font-size: 22px; font-weight: bold;">$0</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
